...
class LiveDetails extends StatefulWidget {
  ...
  @override
  State<LiveDetails> createState() => _RadioDetailsState();
}

class _RadioDetailsState extends State<LiveDetails> {
  ...
  void initState() {
    ...
    _controller = YoutubePlayerController(
      ...
      flags: YoutubePlayerFlags(
        ...
        forceHD: false,
        isLive: true,
        captionLanguage: widget.id.toString(),
        loop: true,
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            //       // fontWeight: FontWeight.w300,
                            //       textAlign: widget.id.toString() == '1'
                            //           ? TextAlign.left
                            //           : TextAlign.right,
                            //       direction: widget.id.toString() == '1'
                            //           ? ui.TextDirection.ltr
                            //           : ui.TextDirection.rtl,
                            //       fontFamily: widget.id == 1
                            //           ? "Arial"

...
class ArticleView extends StatefulWidget {
  ...
  _ArticleViewState? __articleViewState;
  @override
  // State<ArticleView> createState() => _ArticleViewState();
  _ArticleViewState createState() {
    __articleViewState = _ArticleViewState();
    return _ArticleViewState();
  }

  getState() => _ArticleViewState();
}
...
class _ArticleViewState extends State<ArticleView> {
  ...
  // DateTime minago = DateTime(11, 1, 1);
                                ...
                                GestureDetector(
                                    onTap: () async {
                                      setState(() async {
                                        ...
                                        await Share.share(
                                            'https://hurriyat.net/api/news-details/${snapshot.data!.id.toString()}',
                                            subject:
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: CategoryTile(
                                      ...
                                      categoryName: snapshot.data!.newsCategory,
                                    ),
                                  ),
                                  //    Container(
                                  //     // width: 110,

...
import 'package:hurriyat/models/reportsmodels/reports_details.dart' as m;
...
class Reports_Details extends StatefulWidget {
  String? blogUrl;
  Reports_Details({
    this.blogUrl,
  });
...
class _Analysis_DetailState extends State<Reports_Details> {
  ...
  //   }
  // }
  Future<m.ReportsDetails> getdetails() async {
    try {
      dio.Dio _dio = dio.Dio();

      String url = 'https://hurriyat.net/api/reports-details/${widget.blogUrl}';
      ...
      m.ReportsDetails newresponse = m.ReportsDetails.fromJson(response.data);
      return newresponse;
        ...
        actions: [
          _loading
              ...
              : Container(
                  ...
                  child: FutureBuilder<m.ReportsDetails>(
                      future: getdetails(),
                              ...
                              children: [
                                Container(
                                  ...
                                  child: CategoryTile(
                                    ...
                                    categoryName: snapshot.data!.reportCategory,
                                  ),
                                ),
                                Container(

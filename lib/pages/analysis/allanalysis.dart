...
class AllAnalysisPage extends StatefulWidget {
  int languageid;
  // String? videotype;
  AllAnalysisPage({required this.languageid,});

  @override
  State<AllAnalysisPage> createState() => _AllNewsState();
}

class _AllNewsState extends State<AllAnalysisPage> {
  ...
  Future<void> getNews(int languageid) async {
    ...
    try {
      ...
      String url =
          "https://hurriyat.net/api/analysis/$languageid?page=$page_number";
